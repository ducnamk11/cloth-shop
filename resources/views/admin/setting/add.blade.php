                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="config_key" type="text" class="form-control @error('config_key') is-invalid @enderror"
                                       value="{{old('config_key')}}" placeholder="Nhập tên sản phẩm">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                @elseif(request()->type ==='textarea')
                                    <textarea name="config_value" type="text" rows="5"
                                              class="form-control @error('name') is-invalid @enderror"
                                               >{{old('name')}}</textarea>
